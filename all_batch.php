...
?>
<?php
    $s1 = "select b.id as i, b.batch as bat, d.name as dept from batch as b INNER JOIN department as d ON b.dept_id = d.id";
                ...
                <table class="table table-striped">
                    ...
                    <?php
                        while($r = mysqli_fetch_array($q1)){ ?>
                            <tr>
                                <td><?php echo $r['i'] ?></td>
                                <td><?php echo $r['bat'] ?></td>
                                <td><?php echo $r['dept'] ?></td>
                                <td>
                                    <a class="btn btn-secondary" href="edit_batch.php?batch_id=<?php echo $r['i'] ?>">Update</a>
                                    <a class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $r['i'] ?>" >Delete</a>
                                    <div class="modal" id="myModal<?php echo $r['i'] ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">                                                
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to delete batch <?php echo $r['bat'] ?>
                                                </div>                                            
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <a href="delete_batch.php?batch_id=<?php echo $r['i'] ?>" class="btn btn-danger">Yes</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
