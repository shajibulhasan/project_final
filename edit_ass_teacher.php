...
<?php 
    if(isset($_POST['submitBtn'])){
        ...
        $course = $_POST['course'];
        $sec = implode("," ,$section);
        $str = "update assign_teacher set teacher_id='".$teacher."', dept_id='".$dept."', semester='".$semester."' , section='".$sec."', session_id='".$session."', course='".$course."' where id= $ass_id";
