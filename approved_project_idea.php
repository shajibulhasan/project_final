...
<head>
    ...
    <title>Approved Project Idea</title>
        ...
        <div class="m-5">
            ...
            <?php
                if (isset($_GET['btnSearch'])){
                    ...
                    $course =  $_GET['course'];
                    $s = "select pi.id as id, c.course_title as course, pi.idea as idea, pi.group_number as gnum from project_idea as pi INNER JOIN course as c ON pi.course_id=c.id where pi.session_id=$session and pi.course_id = $course and status=1";
                    $q = mysqli_query($conn, $s); ?>
                    <h2 class="m-4">Approved Project Idea</h2>
