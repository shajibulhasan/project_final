                    ...
                    <?php
                        while($r = mysqli_fetch_array($q)){ ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-secondary" href="edit_session.php?session_id=<?php echo $r['id'] ?>">Update</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">                                                
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to delete <?php echo $r['session'] ?>
                                                </div>                                            
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <a href="delete_session.php?session_id=<?php echo $r['id'] ?>" class="btn btn-danger">Yes</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
