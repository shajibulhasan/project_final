...
<?php 
    ...
    $s = "select * from batch where id=$batch_id";
        ...
        <div class="m-5">
            ...
            <form action=""  method="post">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $r['batch'] ?>" class="form-control" name="batch" id="name">
                </div>
                <div class="form-group">
...
<?php 
    if(isset($_POST['submitBtn'])){
        ...
        $str = "update batch set batch='".$batch."', dept_id='".$dept."'where id= $batch_id";
